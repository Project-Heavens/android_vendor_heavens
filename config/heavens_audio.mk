...
ALARM_PATH := vendor/heavens/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/heavens/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/heavens/prebuilt/common/media/audio/ringtones
